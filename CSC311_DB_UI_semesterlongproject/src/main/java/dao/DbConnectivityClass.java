...
public class DbConnectivityClass {
    final static String DB_NAME="csc311dbtemp2";
        MyLogger lg= new MyLogger();
        final static String SQL_SERVER_URL = "jdbc:mysql://csc311biggsserver.mysql.database.azure.com";//update this server name
        ...
        final static String PASSWORD = "Password2154$";// update this password
